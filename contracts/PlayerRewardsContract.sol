...
contract PlayerRewards is Ownable {
    ...
    uint256 constant clif = 90 days;
    uint constant percentage = 69;
    ...
    function withdraw(uint256 today ,uint256 manualLastUnlockTime) external{
        ...
        //require(block.timestamp > lastUnlockTime[msg.sender], "Too early for unlocking tokens");
