...
describe('ReservedFunds', () => {
    let contract;
    let token;

    async function getContracts(){
        let contractTemp = await ethers.getContractFactory('ReservedFunds');
    ...
    describe('withdraw', () => {
        ...
        it("1 day have passed after 6 month cliff", async function() {
            ...
            expect(await token.balanceOf(owner.address)).to.equal(556000000000000000n)
        })
        ...
        it("10 days have passed after 6 month cliff", async function() {
            ...
            expect(await token.balanceOf(owner.address)).to.equal(5560000000000000000n)
        })
        ...
        it("100 days have passed after 6 month cliff", async function() {
            ...
            expect(await token.balanceOf(owner.address)).to.equal(55044000000000000000n)
            expect(await contract.lockedBFG(owner.address)).to.equal(44956000000000000000n)
        })
